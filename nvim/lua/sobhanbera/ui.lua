...
vim.cmd('hi! Pmenu guibg=#0F1419')														-- auto-complete or any menu highlight
vim.cmd('hi! PmenuSel guibg=#0F1419 guifg=#14BC85')										-- highlight for the currently selected menu item
