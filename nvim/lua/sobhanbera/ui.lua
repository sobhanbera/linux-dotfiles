...
vim.cmd("highlight! CmpItemAbbrMatch guibg=NONE guifg=#60A7BD")
vim.cmd("highlight! CmpItemAbbrMatchFuzzy guibg=NONE guifg=#60A7BD")
...
vim.cmd("hi! PmenuSel guibg=#09101A guifg=#60A7BD") -- highlight for the currently selected menu item
vim.cmd("hi! PmenuSbar guibg=NONE") -- the scrollbar highlight
vim.cmd("hi! PmenuThumb guibg=#60A7BD") -- the thumb highlight in menu scrollbar
...
vim.cmd("hi Search guibg=#2B3035 guifg=#60A7BD") -- highlight for the search terms
vim.cmd("hi Visual guibg=#1F2429") -- highlight for the code selection in visual mode

vim.cmd("hi DashboardHeader guifg=#60A7BD")
